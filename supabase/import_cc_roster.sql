...
-- ── 기존 7명 UPDATE (DB id 기준) + CC 고유번호 ────────────────
update creators set code='CC001',
...
update creators set code='CC002',
...
update creators set code='CC003',
...
update creators set code='CC004',
...
update creators set code='CC005',
...
update creators set code='CC006',
...
update creators set code='CC007',
...
-- ── 신규 6명 INSERT + CC 고유번호 ─────────────────────────────
insert into creators (code, name, handle, followers, status, category, sns, rates,
  email, phone, bank_account, entity_type, withholding, contract_date, contract_end, base_fee, pay_cycle)
values
  ('CC008', 'rico', null, 0, 'active', null, '{}'::jsonb, '{"reels":0,"secondary":0,"offline":0,"etc":0}'::jsonb,
  ...
  ('CC009', 'kainoa', null, 0, 'active', null, '{}'::jsonb, '{"reels":0,"secondary":0,"offline":0,"etc":0}'::jsonb,
   null, null, null, 'individual', true, '2026-08-01', null, 230000, '월말마감 익월 10일 지급'),
  ('CC010', 'seina', null, 0, 'active', null, '{}'::jsonb, '{"reels":0,"secondary":0,"offline":0,"etc":0}'::jsonb,
   null, null, null, 'individual', true, '2026-08-01', null, 100000, '월말마감 익월 10일 지급'),
  ('CC011', 'nanako', null, 0, 'active', null, '{}'::jsonb, '{"reels":0,"secondary":0,"offline":0,"etc":0}'::jsonb,
   null, null, null, 'individual', true, '2026-08-01', null, 100000, '월말마감 익월 10일 지급'),
  ('CC012', 'rua', null, 0, 'active', null, '{}'::jsonb, '{"reels":0,"secondary":0,"offline":0,"etc":0}'::jsonb,
   null, null, null, 'individual', true, '2026-08-01', null, 50000, '월말마감 익월 10일 지급'),
  ('CC013', 'momo_osaka', null, 0, 'active', null, '{}'::jsonb, '{"reels":0,"secondary":0,"offline":0,"etc":0}'::jsonb,
